...
if __name__ == "__main__":
    ...
    if args.dataset in vars(datasets):
        dataset = vars(datasets)[args.dataset](path=args.data_dir,file_name=args.data_name,tokenizer_name=args.model_name,split_ratio=[args.n, args.N, args.test_length],max_length=args.max_length,seed=args.seed,flip_prob=args.flip_prob,flip_st=True)
    else:
        raise NotImplementedError

    train_dataset = ConcatDataset([dataset[0],dataset[1]])
    ...
    # Define training arguments
        ...
        trainer = Trainer(
            ...
            eval_dataset={'train':train_dataset,'test':dataset[2]},
        ...
        #     # weight_decay=hparams['weight_decay'] if 'weight_decay' in hparams else 0,
        # )
        # nsteps = len(train_dataset) * args.epoch // hparams['batch_size']
