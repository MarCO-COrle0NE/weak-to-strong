...
cols_interest = [f'env{i}_in_acc' for i in range(2)]+[f'env{i}_out_acc' for i in range(3)]+['epoch','loss','step'] #+['agreement','agreement_neg','agreement_pos']
