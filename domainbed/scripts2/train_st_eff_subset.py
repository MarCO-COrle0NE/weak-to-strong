...
if __name__ == "__main__":
    ...
    if args.indices_dir:
        with open(args.indices_dir+'/indices.json','r') as file:
    ...
    for step in range(start_step, n_steps):
        ...
        if (step % checkpoint_freq == 0) or (step == n_steps - 1):
            ...
            cluster_err = misc.clustering_error(algorithm, target_loader, weights, device, indexed=True)
            cluster_err_all = misc.clustering_error_all(algorithm, eval_loaders, weights, device, indexed=True)
