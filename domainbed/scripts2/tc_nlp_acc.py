...
if __name__ == "__main__":
    ...
    if args.dataset in vars(datasets):
        dataset = vars(datasets)[args.dataset](path=args.data_dir,tokenizer_name=args.model_name,split_ratio=[args.n, args.N, args.test_length],max_length=args.max_length,seed=args.seed)
    else:
    ...
    if args.save_labels:
            ...
            #os.makedirs(os.path.join(args.data_dir,'prajjwal1'), exist_ok=True)
            #os.makedirs(os.path.join(args.data_dir,'microsoft'), exist_ok=True)
            #os.makedirs(os.path.join(args.data_dir,'google'), exist_ok=True)
