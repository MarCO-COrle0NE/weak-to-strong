...
if __name__ == "__main__":
    ...
    algorithm = algorithms.AugmentedAlgorithm(dataset.input_shape, dataset.num_classes,
        len(dataset) - len(args.test_envs), algorithm_base, teachers, dc, args.test_envs[0], hparams)
