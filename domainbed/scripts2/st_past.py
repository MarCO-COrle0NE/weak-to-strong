...
if __name__ == "__main__":
    ...
    for env_i, env in enumerate(dataset):
        ...
        if args.indices_dir and env_i==1:
        ...
        if (step != 0) and (step % checkpoint_freq == 0) or (step == n_steps - 1):
            ...
            for name, loader, weights in evals:
                if str(args.test_envs[0]) in name:
                    acc,loss_eval = misc.acc_loss(algorithm, loader, weights, device, indexed=True)
            ...
            agreement, agreement_neg, agreement_pos = misc.agreement(algorithm, target_loader, None, device, indexed=True)
            ...
            results['cluster_err'] = 0
            results['cluster_err_all'] = 0
