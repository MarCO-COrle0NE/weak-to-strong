...
#    parser.add_argument('--checkpoint_algorithm', type=str, default='ERM')
    ...
    if args.checkpoint:
        ...
        algorithm_base = algorithms.DRCN(dataset.input_shape, dataset.num_classes,
            len(dataset) - len(args.test_envs), state_dict['model_hparams'])
        algorithm_base.load_state_dict(state_dict['model_dict'])
    # Modification Here -------------------------------------------------------------------------
    for i in range(len(train_loaders)):
        ...
        if state_dict is not None:
            algorithm.featurizer = algorithm_base.featurizer
