#!/bin/bash
#SBATCH --job-name=st_nlp_bert_large
...
INPUT_TC=${TC[$IDX_TC]}
INPUT_ST="bert-large-uncased"
#INPUT_ST="roberta-large"
SEED=0
...
accelerate launch --multi_gpu --main_process_port 0 -m domainbed.scripts.st_nlp_acc\
       --data_dir=/scratch/jl4476/data/SST2/\
       --data_name ${INPUT_TC}_${INPUT_SUBSET_INT}.tsv\
       --dataset ${INPUT_DATASET}\
       --model_name $INPUT_TC\
