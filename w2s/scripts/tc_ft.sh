...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":5e-5, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":1, \"alexnet\":0, \"mamba\":0, \"arch\": \"${INPUT_TC}\"}"\
