#!/bin/bash
#SBATCH --job-name=tc_intrinsic_did_large
#SBATCH --array=1-8
...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":$INPUT_LR, \"SGD\":1, \"momentum\":$INPUT_MOMENTUM, \"batch_size\":$INPUT_BATCH, \"input_shape\":224, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"${INPUT_TC}\":1, \"arch\": \"${INPUT_ARCH}\"}"\
