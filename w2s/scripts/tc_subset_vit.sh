...
TC=("vit_tiny")  # 3 teachers
#SUBSET=(0.00273 0.0036 0.005 0.01 0.015 0.02 0.02322)
#SUBSET_INT=(75 100 140 280 420 560 650)
SUBSET=(0.00108 0.0025 0.005 0.007143 0.0143 0.02143)
SUBSET_INT=(30 70 140 200 400 600)
...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":3e-3, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":1, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"tiny\"}"\
...
python3 -m domainbed.scripts.tc\
       ...
       --indices_dir /scratch/jl4476/${INPUT_DATASET}/indices\
       --subset_holdout_fraction ${INPUT_SUBSET}\
       --hparams "{\"lr\":1e-4, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":1, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"tiny\"}"\
       --checkpoint_freq 1000\
       --steps 30001\
       --start_step 10001\
       --test_envs 2\
...
python3 -m domainbed.scripts.tc\
       ...
       --indices_dir /scratch/jl4476/${INPUT_DATASET}/indices\
       --subset_holdout_fraction ${INPUT_SUBSET}\
       --hparams "{\"lr\":3e-5, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":1, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"tiny\"}"\
       --checkpoint_freq 1000\
       --steps 40001\
       --start_step 30001\
       --test_envs 2\
