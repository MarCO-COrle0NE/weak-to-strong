#!/bin/bash
#SBATCH --job-name=tc_lp_mamba_large
#SBATCH --array=1-1
...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":1e-4, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mamba\":1, \"alexnet\":0,  \"arch\": \"${ARCH}\"}"\
