...
SUBSET_ST=(0.1 0.115 0.13 0.147 0.1625 0.2275 0.24375 0.26 0.2925 0.325)
SUBSET_ST_INT=(2800 3220 3640 4116 4550 6370 6825 7280 8190 9100)
...
python3 -m domainbed.scripts.eval_mse\
       ...
       --dataset ${DATASET}\
       --test_env 1\
       --output_dir st_${DATASET}/${INPUT_SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${INPUT_SUBSET_ST_INT}_${INPUT_ST}\
       --checkpoint ${DATASET}/st_resnet_hard/${INPUT_SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${INPUT_SUBSET_ST_INT}_${INPUT_ST}\
       ...
       #--hparams "{\"lr\":3e-3, \"batch_size\":512, \"input_shape\":224, \"T\":9, \"tc_temperature\":9, \"index_dataset\":0, \"model\": \"${STS}\", \"resnet\":1, \"vit\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"${INPUT_ST}\"}"
