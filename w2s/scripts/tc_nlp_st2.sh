...
ST=("prajjwal1/bert-medium" "bert-base-uncased" "roberta-base")
SUBSET=(4000 8000 12000)
SUBSET_ST=(28000 36000 44000)
...
IDX_ST=$((TASK_ID / $((${#SUBSET[@]} * ${#SUBSET_ST[@]})))) # Get index for ST
...
python3 -m domainbed.scripts.st_nlp\
       ...
       --model_name $INPUT_ST\
       --hparams "{\"lr\":3e-5, \"batch_size\":32, \"weight_decay\":0.0001, \"warmup_steps\":100}"\
       --n $INPUT_SUBSET_INT\
       --N $INPUT_N\
       --test_length 7349\
       --epoch 4\
...
#        --seed $SEED\
#        --trial_seed $SEED\
#        --output_dir /scratch/jl4476/${INPUT_DATASET}/st/${SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${INPUT_SUBSET_ST}_${INPUT_ST}\
