...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":1e-3, \"batch_size\":512, \"w_or_s\":\"w\", \"d\":2048,\"d_s\":$D_S, \"d_w\":$D_W, \"d_sw\":$INPUT_DSW, \"W_dir\":\"/scratch/jl4476/${W_DIR}\", \"input_shape\":224, \"resnet18\":1, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"arch\": \"18\"}"\
...
python3 -m domainbed.scripts.tc\
       ...
       --indices_dir /scratch/jl4476/${INPUT_DATASET}/indices\
       --subset_holdout_fraction ${INPUT_SUBSET}\
       --hparams "{\"lr\":5e-4,  \"batch_size\":512, \"w_or_s\":\"w\",\"d\":2048, \"d_s\":$D_S, \"d_w\":$D_W, \"d_sw\":$INPUT_DSW, \"W_dir\":\"/scratch/jl4476/${W_DIR}\", \"input_shape\":224, \"resnet18\":1, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"arch\": \"18\"}"\
       --checkpoint_freq 1000\
       --steps 20001\
       --start_step 10001\
       --test_envs 2\
...
python3 -m domainbed.scripts.tc\
       ...
       --indices_dir /scratch/jl4476/${INPUT_DATASET}/indices\
       --subset_holdout_fraction ${INPUT_SUBSET}\
       --hparams "{\"lr\":1e-4,  \"batch_size\":512, \"w_or_s\":\"w\",\"d\":2048, \"d_s\":$D_S, \"d_w\":$D_W, \"d_sw\":$INPUT_DSW, \"W_dir\":\"/scratch/jl4476/${W_DIR}\", \"input_shape\":224, \"resnet18\":1, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"arch\": \"18\"}"\
       --checkpoint_freq 1000\
       --steps 30001\
       --start_step 20001\
       --test_envs 2\
...
python3 -m domainbed.scripts.tc\
       ...
       --indices_dir /scratch/jl4476/${INPUT_DATASET}/indices\
       --subset_holdout_fraction ${INPUT_SUBSET}\
       --hparams "{\"lr\":3e-5, \"batch_size\":512, \"w_or_s\":\"w\",\"d\":2048, \"d_s\":$D_S, \"d_w\":$D_W, \"d_sw\":$INPUT_DSW, \"W_dir\":\"/scratch/jl4476/${W_DIR}\", \"input_shape\":224, \"resnet18\":1, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"arch\": \"18\"}"\
       --checkpoint_freq 1000\
       --steps 50001\
       --start_step 30001\
       --test_envs 2\
...
python3 -m domainbed.scripts.diction_single\
       ...
       --hparams "{\"lr\":3e-3, \"batch_size\":512, \"w_or_s\":\"w\",\"d\":2048, \"d_s\":$D_S, \"d_w\":$D_W, \"d_sw\":$INPUT_DSW, \"W_dir\":\"/scratch/jl4476/${W_DIR}\", \"input_shape\":224, \"resnet18\":1, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"arch\": \"18\"}"\
       --dataset ${INPUT_DATASET}\
       --test_env 1\
       --deterministic_only\
...
mkdir -p ${INPUT_DATASET}/diction/${SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${D_W}_${INPUT_DSW}_atmpt2/
rsync -av --ignore-existing /scratch/$USER/${INPUT_DATASET}/diction/${SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${D_W}_${INPUT_DSW}/ ./${INPUT_DATASET}/diction/${SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${D_W}_${INPUT_DSW}_atmpt2/
