#!/bin/bash
#SBATCH --job-name=st_resnet50_dsw
#SBATCH --array=1-6
...
rsync -av --ignore-existing ./${DATASET}/diction/${INPUT_SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${D_W}_${INPUT_DSW}/ /scratch/$USER/${DATASET}/diction/${INPUT_SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${D_W}_${INPUT_DSW}/
...
python3 -m domainbed.scripts.st\
       ...
       --hparams "{\"lr\":1e-2, \"SGD\":1, \"momentum\":0.9,\"batch_size\":512, \"w_or_s\":\"s\", \"d_s\":$D_S, \"d_w\":$D_W, \"d_sw\":$INPUT_DSW, \"input_shape\":224, \"T\":9, \"tc_temperature\":9, \"index_dataset\":1, \"model\": \"${STS}\", \"resnet50_augmix\":1, \"vit\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"${INPUT_ST}\"}"\
       --dinov\
       --seed $INPUT_SEED\
...
python3 -m domainbed.scripts.st\
       ...
       --dataset ${DATASET}\
       --task domain_adaptation\
       --hparams "{\"lr\":1e-3, \"SGD\":1, \"momentum\":0.0,\"batch_size\":512, \"w_or_s\":\"s\", \"d_s\":$D_S, \"d_w\":$D_W, \"d_sw\":$INPUT_DSW, \"input_shape\":224, \"T\":9, \"tc_temperature\":9, \"index_dataset\":1, \"model\": \"${STS}\", \"resnet50_augmix\":1, \"vit\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"${INPUT_ST}\"}"\
       --dinov\
       --seed $INPUT_SEED\
       --trial_seed $INPUT_SEED\
       --subset_holdout_fraction ${INPUT_SUBSET_ST}\
...
python3 -m domainbed.scripts.st\
       ...
       --dataset ${DATASET}\
       --task domain_adaptation\
       --hparams "{\"lr\":1e-4, \"SGD\":1, \"momentum\":0.0,\"batch_size\":512, \"w_or_s\":\"s\", \"d_s\":$D_S, \"d_w\":$D_W, \"d_sw\":$INPUT_DSW, \"input_shape\":224, \"T\":9, \"tc_temperature\":9, \"index_dataset\":1, \"model\": \"${STS}\", \"resnet50_augmix\":1, \"vit\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"${INPUT_ST}\"}"\
       --dinov\
       --seed $INPUT_SEED\
       --trial_seed $INPUT_SEED\
       --subset_holdout_fraction ${INPUT_SUBSET_ST}\
...
mkdir -p ${DATASET}/st_resnet_dsw/${INPUT_SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${D_W}_${INPUT_SUBSET_ST_INT}_${INPUT_ST}_${D_S}_${INPUT_DSW}
cp /scratch/jl4476/${DATASET}/st_resnet_dsw/${INPUT_SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${D_W}_${INPUT_SUBSET_ST_INT}_${INPUT_ST}_${D_S}_${INPUT_DSW}/results.jsonl ${DATASET}/st_resnet_dsw/${INPUT_SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${D_W}_${INPUT_SUBSET_ST_INT}_${INPUT_ST}_${D_S}_${INPUT_DSW}/