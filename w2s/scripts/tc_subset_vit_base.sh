...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":3e-3, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":1, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"base\"}"\
...
python3 -m domainbed.scripts.tc\
       ...
       --indices_dir /scratch/jl4476/${INPUT_DATASET}/indices\
       --subset_holdout_fraction ${INPUT_SUBSET}\
       --hparams "{\"lr\":1e-4, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":1, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"base\"}"\
       --checkpoint_freq 1000\
       --steps 30001\
       --start_step 10001\
       --test_envs 2\
...
python3 -m domainbed.scripts.tc\
       ...
       --indices_dir /scratch/jl4476/${INPUT_DATASET}/indices\
       --subset_holdout_fraction ${INPUT_SUBSET}\
       --hparams "{\"lr\":3e-5, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":1, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"clip\":0, \"dinov2\":0, \"dino\":0, \"arch\": \"base\"}"\
       --checkpoint_freq 1000\
       --steps 40001\
       --start_step 30001\
       --test_envs 2\
