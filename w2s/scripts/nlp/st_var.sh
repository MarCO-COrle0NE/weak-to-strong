...
python3 -m domainbed.scripts.st_nlp\
       ...
       --output_dir /scratch/jl4476/${INPUT_DATASET}/st/${SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${INPUT_N}_${INPUT_ST}_${INPUT_FLIP}\
...
mkdir -p /auto/u/jl4476/w2s/${INPUT_DATASET}/st/${SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${INPUT_SUBSET_ST}_${INPUT_ST}_${INPUT_FLIP}/
cp -rf /scratch/jl4476/${INPUT_DATASET}/st/${SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${INPUT_SUBSET_ST}_${INPUT_ST}_${INPUT_FLIP}/logs /auto/u/jl4476/w2s/${INPUT_DATASET}/st/${SEED}/${INPUT_SUBSET_INT}_${INPUT_TC}_${INPUT_SUBSET_ST}_${INPUT_ST}_${INPUT_FLIP}/