...
# SUBSET_ST=(5000 9000 10000 11000 12000 13000 14000 15000 20000 25000 30000)
# SUBSET=(6000 7000 8000 9000 10000)
# SUBSET_ST=(5000 25000 30000)
SUBSET=(10000)
SUBSET_ST=(15000 17500 20000 22500 25000 27500 30000)
SUBSET=(12000 13000)
SUBSET_ST=(15000 17000 20000 30000)
...
python3 -m domainbed.scripts.st_nlp\
       ...
       --model_name $INPUT_ST\
       --hparams "{\"lr\":1e-5, \"batch_size\":32, \"weight_decay\":0.0001, \"warmup_steps\":${INPUT_WARMUP}}"\
       --n $INPUT_SUBSET_INT\
       --N $INPUT_N\
       --test_length 4349\
       --epoch 15\
