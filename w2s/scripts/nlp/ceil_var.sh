...
IDX_FLIP=$((TASK_ID / $((${#SUBSET[@]} * ${#SUBSET_ST[@]})))) # Get index for ST
...
accelerate launch --multi_gpu --num_processes 2 --main_process_ip $MASTER_ADDR --main_process_port $MASTER_PORT -m domainbed.scripts.ceil_nlp_acc\
       ...
       --output_dir /scratch/jl4476/${INPUT_DATASET}/ceil/${SEED}/${INPUT_SUBSET_INT}_${INPUT_N}_${INPUT_ST}_${INPUT_FLIP}\

mkdir -p /auto/u/jl4476/w2s/${INPUT_DATASET}/ceil/${SEED}/${INPUT_SUBSET_INT}_${INPUT_SUBSET_ST}_${INPUT_ST}_${INPUT_FLIP}/
cp -rf /scratch/jl4476/${INPUT_DATASET}/ceil/${SEED}/${INPUT_SUBSET_INT}_${INPUT_SUBSET_ST}_${INPUT_ST}_${INPUT_FLIP}/logs /auto/u/jl4476/w2s/${INPUT_DATASET}/ceil/${SEED}/${INPUT_SUBSET_INT}_${INPUT_SUBSET_ST}_${INPUT_ST}_${INPUT_FLIP}/