...
#        --model_name $INPUT_TC\
#        --hparams "{\"lr\":1e-5, \"batch_size\":8, \"weight_decay\":0.0, \"warmup_steps\":0, \"gradient_accumulation_steps\":4}"\
#        --n $INPUT_SUBSET_INT\
#        --N $INPUT_N\
#        --test_length 4349\
#        --epoch 2\
...
accelerate launch --multi_gpu --num_processes 4 --main_process_ip $MASTER_ADDR --main_process_port $MASTER_PORT -m domainbed.scripts.tc_nlp_acc\
       ...
       --dataset ${INPUT_DATASET}\
       --model_name $INPUT_TC\
       --hparams "{\"lr\":$LR, \"batch_size\":2, \"weight_decay\":0.0, \"warmup_steps\":0,\"gradient_accumulation_steps\":4}"\
       --n $INPUT_SUBSET_INT\
       --N $INPUT_N\
       --test_length 4349\
       --epoch 2\
