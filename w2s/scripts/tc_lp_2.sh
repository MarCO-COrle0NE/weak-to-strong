...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":7e-5, \"batch_size\":512, \"input_shape\":224, \"resnet\":1, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":0, \"mamba\":0, \"arch\": \"152\"}"\
       --checkpoint_freq 1000\
       --steps 70001\
       --start_step 40001\
       --test_envs 2\
       --output_dir ${INPUT_DATASET}/tc/${INPUT_SUBSET}_${INPUT_TC}_152\
       --freeze\
       --deterministic_only\
