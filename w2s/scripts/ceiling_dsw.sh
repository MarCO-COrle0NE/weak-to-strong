#!/bin/bash
#SBATCH --job-name=ceiling_ds_resnet50_SGD
#SBATCH --array=1-5
...
python3 -m domainbed.scripts.ceiling\
       ...
       --dataset ${DATASET}\
       --hparams "{\"lr\":1e-3, \"SGD\":1, \"momentum\":0.0,\"batch_size\":256, \"input_shape\":224, \"w_or_s\":\"s\", \"d_s\":$INPUT_D_S, \"d_w\":133, \"d_sw\":$INPUT_D_S, \"model\": \"${STS}\", \"resnet18\":0, \"vit\":0, \"resnet50_augmix\":1, \"dinov2\":0, \"dino\":0, \"arch\": \"${INPUT_ST}\"}"\
       --seed $INPUT_SEED\
       ...
       --test_envs 2\
       --output_dir /scratch/jl4476/${DATASET}/ceiling_dsw/${INPUT_SEED}/${STS}_${INPUT_ST}_${INPUT_D_S}\
       --freeze\
       --mse\
...
python3 -m domainbed.scripts.ceiling\
       --data_dir=/scratch/$USER/data/\
       --dataset ${DATASET}\
       --hparams "{\"lr\":1e-4, \"SGD\":1, \"momentum\":0.0, \"batch_size\":256, \"input_shape\":224, \"w_or_s\":\"s\", \"d_s\":$INPUT_D_S, \"d_w\":133, \"d_sw\":$INPUT_D_S, \"model\": \"${STS}\", \"resnet18\":0, \"vit\":0, \"resnet50_augmix\":1, \"dinov2\":0, \"dino\":0, \"arch\": \"${INPUT_ST}\"}"\
       --seed $INPUT_SEED\
       --trial_seed $INPUT_SEED\
       --start_step 10001\
       --steps 30001\
       ...
       --test_envs 2\
       --output_dir /scratch/jl4476/${DATASET}/ceiling_dsw/${INPUT_SEED}/${STS}_${INPUT_ST}_${INPUT_D_S}\
       --checkpoint /scratch/jl4476/${DATASET}/ceiling_dsw/${INPUT_SEED}/${STS}_${INPUT_ST}_${INPUT_D_S}\
       --checkpoint_erm\
       --freeze\
       --mse\
...
python3 -m domainbed.scripts.ceiling\
       --data_dir=/scratch/$USER/data/\
       --dataset ${DATASET}\
       --hparams "{\"lr\":1e-5, \"SGD\":1, \"momentum\":0.0, \"batch_size\":256, \"input_shape\":224, \"w_or_s\":\"s\", \"d_s\":$INPUT_D_S, \"d_w\":133, \"d_sw\":$INPUT_D_S, \"model\": \"${STS}\", \"resnet18\":0, \"vit\":0, \"resnet50_augmix\":1, \"dinov2\":0, \"dino\":0, \"arch\": \"${INPUT_ST}\"}"\
       --seed $INPUT_SEED\
       --trial_seed $INPUT_SEED\
       --start_step 30001\
       --steps 40001\
