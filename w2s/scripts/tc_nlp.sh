...
TC=("albert-base-v1" "prajjwal1/bert-tiny" "prajjwal1/bert-mini" "prajjwal1/bert-small" "prajjwal1/bert-medium" "bert-base-uncased" "bert-large-uncased" "roberta-base" "roberta-large" "distilbert-base-uncased" "distilroberta-base" "albert-base-v2" "albert-xxlarge-v2" "microsoft/deberta-v3-xsmall" "microsoft/deberta-v3-small" "microsoft/deberta-v3-base" "microsoft/deberta-v3-large")  # 3 teachers
TC=("albert-base-v1" "prajjwal1/bert-tiny" "prajjwal1/bert-mini" "prajjwal1/bert-small" "prajjwal1/bert-medium" "bert-base-uncased" "bert-large-uncased" "roberta-base" "roberta-large" "distilbert-base-uncased" "albert-base-v2"  "microsoft/deberta-v3-xsmall" "microsoft/deberta-v3-small" "microsoft/deberta-v3-base")  # 3 teachers
TC=("distilbert-base-uncased" "distilroberta-base" "google/electra-small-discriminator" "google/electra-base-discriminator")
...
python3 -m domainbed.scripts.tc_nlp\
       ...
       --model_name $INPUT_TC\
       --hparams "{\"lr\":1e-4, \"batch_size\":32, \"warmup_steps\":0}"\
       --n $INPUT_SUBSET_INT\
       --N 1000\
       --test_length 10000\
       --epoch 20\
...
# accelerate launch --multi_gpu -m domainbed.scripts.tc_nlp_acc\
#        --data_dir=/scratch/jl4476/data/SST2/\
#        --dataset ${INPUT_DATASET}\
#        --model_name $INPUT_TC\
#        --hparams "{\"lr\":3e-5, \"batch_size\":16, \"weight_decay\":0.0001, \"warmup_steps\":500}"\
#        --n $INPUT_SUBSET_INT\
#        --N 1000\
#        --test_length 10000\
#        --epoch 10\
