#!/bin/bash
#SBATCH --job-name=tc_intrinsic_did_mamba
#SBATCH --array=3,6,9
...
TC=("resnet18" "mobile" "mamba")  # 3 teachers
ARCH=("resnet18" "alexnet" "femto")
#SUBSET=(1 0.02 0.05 0.07 0.1 0.2 0.5 0.75 1)
SUBSET=(1)
#INTRINSIC_DIM=(100 200 300 400)
INTRINSIC_DIM=(60 80 100 110)
#INTRINSIC_DIM=(100 110 115 120 125)
#SUBSET=(0.5 0.25 0.125)  # 3 students
DATASET=("ColoredMNISTID") 
LR=(2e-1 1e-1 8e-1 1e-1)
...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":5e-3, \"SGD\":1, \"momentum\":0.0, \"batch_size\":256, \"input_shape\":224, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"${INPUT_TC}\":1, \"arch\": \"${INPUT_ARCH}\"}"\
       --checkpoint_freq 2000\
       --steps 60001\
       --start_step 20001\
       --test_envs 2\
       --intrinsic_dimension $INPUT_DIM\
       --output_dir ${INPUT_DATASET}/tc_intrinsic_did/${INPUT_SUBSET}_${INPUT_TC}_${INPUT_DIM}\
       --checkpoint ${INPUT_DATASET}/tc_intrinsic_did/${INPUT_SUBSET}_${INPUT_TC}_${INPUT_DIM}\
       --checkpoint_erm\
