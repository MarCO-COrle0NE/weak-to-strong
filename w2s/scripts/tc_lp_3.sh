...
python3 -m domainbed.scripts.tc\
       ...
       --hparams "{\"lr\":3e-3, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":1, \"mamba\":0, \"arch\": \"${INPUT_TC}\"}"\
       --checkpoint_freq 1000\
       --steps 5000\
       --start_step 1\
       --test_envs 2\
       --output_dir ${INPUT_DATASET}/tc/${INPUT_SUBSET}_${INPUT_TC}\
...
python3 -m domainbed.scripts.tc\
       ...
       --dataset ${INPUT_DATASET}\
       --subset_holdout_fraction ${INPUT_SUBSET}\
       --hparams "{\"lr\":1e-4, \"batch_size\":512, \"input_shape\":224, \"resnet18\":0, \"resnet50_augmix\":0, \"vit\":0, \"model\": \"${INPUT_TC}\", \"mobile\":0, \"alexnet\":1, \"mamba\":0, \"arch\": \"${INPUT_TC}\"}"\
       --checkpoint ${INPUT_DATASET}/tc/${INPUT_SUBSET}_${INPUT_TC}\
       --checkpoint_freq 1000\
       --steps 10000\
       --start_step 5001\
       --test_envs 2\
